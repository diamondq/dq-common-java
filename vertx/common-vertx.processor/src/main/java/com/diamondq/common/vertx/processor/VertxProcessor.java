...
public class VertxProcessor extends AbstractProcessor {
  ...
  private static final Logger sLogger = LoggerFactory.getLogger(VertxProcessor.class);
        ...
        for (Element annotatedElement : pRoundEnv.getElementsAnnotatedWith(pair.getKey())) {
          ...
          try {
            try {
              ...
              if (annotatedElement.getKind() != ElementKind.INTERFACE) throw new ElementIllegalArgumentException(
                annotatedElement,
              ...
              throw new ElementIllegalArgumentException(annotatedElement,
                ex,
                Messages.PROXYGENERATOR_ERROR,
