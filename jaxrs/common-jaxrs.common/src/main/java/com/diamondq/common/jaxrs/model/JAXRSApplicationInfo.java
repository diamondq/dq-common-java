...
public interface JAXRSApplicationInfo {
	...
	/**
	 * Get a set of root resource, provider and {@link Feature feature} classes. The default life-cycle for resource
	 * class instances is per-request. The default life-cycle for providers (registered directly or via a feature) is
	 * singleton.
	 * <p>
