...
public abstract class AbstractDocumentPersistenceLayer<STRUCTURECONFIGOBJ, STRUCTUREOPTIMISTICOBJ>
  ...
  protected boolean internalWriteStructure(Toolkit pToolkit, Scope pScope, String pDefName, String pKey,
    ...
    try (Context context = mContextFactory.newContext(AbstractDocumentPersistenceLayer.class,
      this,
      pDefName,
      pKey,
      pStructure,
      pMustMatchOldStructure,
      pOldStructure
    )) {
      if (mPersistStructures == false) return context.exit(true);

      STRUCTURECONFIGOBJ config;
      boolean changed = false;

      @Nullable STRUCTUREOPTIMISTICOBJ optimisticObj;
      if (pMustMatchOldStructure == true) {
        optimisticObj = constructOptimisticObj(pToolkit, pScope, pDefName, pKey, pOldStructure);
        @Nullable STRUCTURECONFIGOBJ loadedConfig = loadStructureConfigObject(pToolkit, pScope, pDefName, pKey, false);
        if (pOldStructure == null) {
          if (loadedConfig == null) {
            ...
            config = loadedConfig;
          } else config = loadedConfig;
        } else {
          if (loadedConfig == null) return context.exit(false);
          config = loadedConfig;
        }
      } else {
        @Nullable STRUCTURECONFIGOBJ loadedConfig = loadStructureConfigObject(pToolkit, pScope, pDefName, pKey, false);
      ...
      String oldStructureDefName = getStructureConfigObjectProp(pToolkit,
        pScope,
        config,
        true,
        "structureDef",
      ...
      if (Objects.equals(oldStructureDefName, newStructureDefName) == false) {
        setStructureConfigObjectProp(pToolkit,
          pScope,
          config,
          true,
          "structureDef",
      ...
      for (Property<?> p : properties.values()) {
        ...
        if (propDef.getKeywords().containsEntry(CommonKeywordKeys.PERSIST, CommonKeywordValues.FALSE) == true) continue;
          ...
          if (containerValue.contains(CommonKeywordValues.CONTAINER_PARENT)) {
            ...
            if (parentPropRef != null) {
              ...
              if (structureAndProperty != null) {
                ...
                if (property != null) {
                  @SuppressWarnings(
                    "unchecked") List<StructureRef> structureRefList = (List<StructureRef>) property.getValue(
                    structureAndProperty.structure);
                  ...
                  if (invalidate == true) invalidateStructure(pToolkit, pScope, structureAndProperty.structure);
                }
              }
            }
          }
          if (persistContainerProp(pToolkit, pScope, pStructure, p) == false) continue;
        }
        ...
        switch (p.getDefinition().getType()) {
          case String: {
            if (p.isValueSet() == true) {
              String value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.String)
                == true) changed = true;
            }
            break;
          }
          case Boolean: {
            if (p.isValueSet() == true) {
              Boolean value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.Boolean)
                == true) changed = true;
            }
            break;
          }
          case Decimal: {
            if (p.isValueSet() == true) {
              BigDecimal value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              BigDecimal newDec;
              if (newValue == null) newDec = new BigDecimal(0.0);
              else if (newValue instanceof BigDecimal) newDec = (BigDecimal) newValue;
              else if (newValue instanceof BigInteger) newDec = new BigDecimal((BigInteger) newValue);
              else if (newValue instanceof Byte) newDec = new BigDecimal((Byte) newValue);
              else if (newValue instanceof Double) newDec = new BigDecimal((Double) newValue);
              else if (newValue instanceof Float) newDec = new BigDecimal((Float) newValue);
              else if (newValue instanceof Integer) newDec = new BigDecimal((Float) newValue);
              else if (newValue instanceof Long) newDec = new BigDecimal((Long) newValue);
              else if (newValue instanceof Short) newDec = new BigDecimal((Short) newValue);
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.Decimal)
                == true) changed = true;
            }
            break;
          }
          case Integer: {
            if (p.isValueSet() == true) {
              Integer value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.Integer)
                == true) changed = true;
            }
            break;
          }
          case Long: {
            if (p.isValueSet() == true) {
              Long value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
          ...
          case PropertyRef: {
            if (p.isValueSet() == true) {
              ...
              String newValue;
              if (newValueRef == null) newValue = "";
              else newValue = newValueRef.getSerializedString();
              if (Objects.equals(value, newValue) == false) {
                setStructureConfigObjectProp(pToolkit,
                  pScope,
                  config,
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.PropertyRef)
                == true) changed = true;
            }
            break;
          }
          case StructureRef: {
            if (p.isValueSet() == true) {
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.StructureRef)
                == true) changed = true;
            }
            break;
          }
          case StructureRefList: {
            if (p.isValueSet() == true) {
              ...
              if (newValues == null) newValues = new String[0];
              ...
              if (removeStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
          ...
          case Binary: {
            if (p.isValueSet() == true) {
              Object value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.Binary)
                == true) changed = true;
            }
            break;
          }
          case Timestamp: {
            if (p.isValueSet() == true) {
              ...
              if (removeStructureConfigObjectProp(pToolkit, pScope, config, false, propName, PropertyType.Timestamp)
                == true) changed = true;
            }
            break;
          }
          case UUID: {
            if (p.isValueSet() == true) {
              UUID value = hasProp == true ? getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              if (newValue == null) newValue = UUID.fromString("00000000-0000-0000-0000-000000000000");
              if (Objects.equals(value, newValue) == false) {
      ...
      if ((changed == true) || (isStructureConfigChanged(pToolkit, pScope, config) == true))
        return context.exit(saveStructureConfigObject(pToolkit,
          pScope,
          pDefName,
          pKey,
          config,
  ...
  public Collection<Structure> getAllStructuresByDefinition(Toolkit pToolkit, Scope pScope, StructureDefinitionRef pRef,
    ...
    if (mPersistStructures == false) return Collections.emptyList();
    ...
    if (sd != null) {
      ...
      internalPopulateChildStructureList(pToolkit,
        pScope,
        null,
        sd,
        sd.getName(),
      ...
      for (StructureRef ref : builder.build()) {
        ...
        if (resolution != null) sBuilder.add(resolution);
      }
    }
  ...
  protected @Nullable Structure internalLookupStructureByName(Toolkit pToolkit, Scope pScope, String pDefName,
    ...
    try (Context context = mContextFactory.newContext(AbstractDocumentPersistenceLayer.class, this, pDefName, pKey)) {
      ...
      if (mPersistStructures == false) return context.exit(null);

      @Nullable STRUCTURECONFIGOBJ config = loadStructureConfigObject(pToolkit, pScope, pDefName, pKey, false);
      if (config == null) return context.exit(null);
  ...
  protected Structure convertToStructure(Toolkit pToolkit, Scope pScope, String pKey, STRUCTURECONFIGOBJ config) {
    try (Context context = mContextFactory.newContext(AbstractDocumentPersistenceLayer.class, this, pKey, config)) {
      String fullStructureDefName = getStructureConfigObjectProp(pToolkit,
        pScope,
        config,
        true,
        "structureDef",
      ...
      StructureDefinition structureDef = pScope.getToolkit()
        .lookupStructureDefinitionByNameAndRevision(pScope, structureDefName, revision);
      if (structureDef == null) throw new IllegalArgumentException(
        "The structure at " + pKey + " refers to a StructureDefinition " + structureDefName + ":" + String.valueOf(
      ...
      if (secondLastSlash != -1) parentRef = pKey.substring(0, secondLastSlash);
      if (parentRef != null) {
        Collection<Property<@Nullable PropertyRef<?>>> parentProps = structure.lookupPropertiesByKeyword(
          CommonKeywordKeys.CONTAINER,
      ...
      Collection<String> childrenPropNames = structureDef.lookupPropertyDefinitionNamesByKeyword(CommonKeywordKeys.CONTAINER,
      ...
      if (childrenPropNames.isEmpty() == false) {
        for (String childrenPropName : childrenPropNames) {
          ...
          if ((propDef == null) || (childProp == null)) continue;
        ...
        switch (p.getDefinition().getType()) {
          case String: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              @Nullable String string = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              @SuppressWarnings("unchecked") Property<@Nullable String> ap = (Property<@Nullable String>) p;
          ...
          case Boolean: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              boolean value = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              @SuppressWarnings("unchecked") Property<@Nullable Boolean> ap = (Property<@Nullable Boolean>) p;
          ...
          case Decimal: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              BigDecimal value = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              @SuppressWarnings("unchecked") Property<@Nullable BigDecimal> ap = (Property<@Nullable BigDecimal>) p;
              ap = ap.setValue(value);
              structure = structure.updateProperty(ap);
            }
            break;
          ...
          case Integer: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              ...
              @SuppressWarnings("unchecked") Property<@Nullable Integer> ap = (Property<@Nullable Integer>) p;
              ap = ap.setValue(value);
              structure = structure.updateProperty(ap);
            }
            break;
          ...
          case Long: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              ...
              @SuppressWarnings("unchecked") Property<@Nullable Long> ap = (Property<@Nullable Long>) p;
              ap = ap.setValue(value);
              structure = structure.updateProperty(ap);
            }
            break;
          ...
          case PropertyRef: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              String string = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              @SuppressWarnings(
                "unchecked") Property<@Nullable PropertyRef<?>> ap = (Property<@Nullable PropertyRef<?>>) p;
              ap = ap.setValue(ref);
              structure = structure.updateProperty(ap);
            }
            break;
          ...
          case StructureRef: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              ...
              @SuppressWarnings("unchecked") Property<@Nullable StructureRef> ap = (Property<@Nullable StructureRef>) p;
              ap = ap.setValue(ref);
              structure = structure.updateProperty(ap);
            }
            break;
          ...
          case Binary: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              byte @Nullable [] bytes = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              @SuppressWarnings("unchecked") Property<byte @Nullable []> ap = (Property<byte @Nullable []>) p;
          ...
          case Timestamp: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              Long value = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
          ...
          case UUID: {
            if (hasStructureConfigObjectProp(pToolkit, pScope, config, false, propName) == true) {
              @Nullable UUID uuid = getStructureConfigObjectProp(pToolkit,
                pScope,
                config,
                false,
                propName,
              ...
              @SuppressWarnings("unchecked") Property<@Nullable UUID> ap = (Property<@Nullable UUID>) p;
              ap = ap.setValue(uuid);
              structure = structure.updateProperty(ap);
            }
            break;
      ...
      if (latestRevision == null) throw new IllegalArgumentException();

      if (revision != latestRevision) {
        if (revision > latestRevision) throw new IllegalArgumentException();

        /* We need to find the migration path to move us from one to the other */

        List<Pair<Integer, List<BiFunction<Structure, Structure, Structure>>>> migrationPath = pToolkit.determineMigrationPath(
          pScope,
          structureDefName,
          revision,
          latestRevision
        );
        if (migrationPath == null) throw new IllegalArgumentException();

        Structure oldStructure = structure;
        for (Pair<Integer, List<BiFunction<Structure, Structure, Structure>>> pair : migrationPath) {

          StructureDefinition newStructureDef = pToolkit.lookupStructureDefinitionByNameAndRevision(pScope,
            structureDefName,
            pair.getValue0()
          );
  ...
  protected @Nullable StructureDefinition internalLookupStructureDefinitionByNameAndRevision(Toolkit pToolkit,
    ...
    if (mPersistStructureDefinitions == false) return null;
  ...
  protected Collection<StructureDefinitionRef> internalGetAllMissingStructureDefinitionRefs(Toolkit pToolkit,
    ...
    if (mPersistStructureDefinitions == false) return Collections.emptyList();
    throw new UnsupportedOperationException();
  }
  ...
  protected void internalDeleteStructureDefinition(Toolkit pToolkit, Scope pScope, StructureDefinition pValue) {
    if (mPersistStructureDefinitions == false) return;
  ...
  protected @Nullable String internal2LookupResourceString(Toolkit pToolkit, Scope pScope, Locale pLocale,
    String pKey) {
    if (mPersistResources == false) return null;
  ...
  protected void internalWriteResourceString(Toolkit pToolkit, Scope pScope, Locale pLocale, String pKey,
    String pValue) {
    if (mPersistResources == false) return;
  ...
  public boolean isResourceStringWritingSupported(Toolkit pToolkit, Scope pScope) {
    if (mPersistResources == false) return true;
    throw new UnsupportedOperationException();
  }
  ...
  protected @Nullable List<EditorStructureDefinition> internalLookupEditorStructureDefinitionByName(Toolkit pToolkit,
    ...
    if (mPersistEditorStructureDefinitions == false) return null;
    throw new UnsupportedOperationException();
  }
  ...
  protected void internalWriteEditorStructureDefinition(Toolkit pToolkit, Scope pScope,
    ...
    if (mPersistEditorStructureDefinitions == false) return;
    throw new UnsupportedOperationException();
  }
  ...
  protected @Nullable String constructOptimisticStringObj(Toolkit pToolkit, Scope pScope, String pDefName, String pKey,
    ...
    if (pStructure instanceof Revision) {
      ...
      if (r.supportsRevisions() == true) {
        ...
        if (revision instanceof String) return (String) revision;
    ...
    for (String propName : new TreeSet<>(pStructure.getDefinition().getAllProperties().keySet())) {
      ...
      @Nullable Property<@Nullable Object> prop = pStructure.lookupPropertyByName(propName);
      if (prop != null) {
        @Nullable Object value = prop.getValue(pStructure);
