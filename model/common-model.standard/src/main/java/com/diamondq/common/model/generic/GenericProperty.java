...
public class GenericProperty<@Nullable TYPE> implements Property<TYPE> {
  ...
  public GenericProperty(PropertyDefinition pPropertyDefinition, boolean pValueSet, TYPE pValue,
    ...
    mValueSet = pValueSet;
    mValue = pValue;
    mSupplier = (pSupplier == null ? null : new MemoizedSupplier<>(pSupplier));
  }
  ...
  public Property<TYPE> setValue(TYPE pValue) {
    ...
    /*
     * Because the TYPE is a Generic, and can be lost in type-erasure or can be modeled as a <?>, we should see if we
     * need to 'convert' the data type before passing it to the constructor
     */
    ...
    return new GenericProperty<>(mPropertyDefinition, true, pValue, null);
  }
  ...
  public Property<TYPE> setLazyLoadSupplier(@Nullable Supplier<TYPE> pSupplier) {
    return new GenericProperty<>(mPropertyDefinition, (pSupplier == null ? mValueSet : true), mValue, pSupplier);
  }
