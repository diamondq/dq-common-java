...
public class CombinedReadWritePersistenceLayer extends AbstractPersistenceLayer {
	...
	public void deleteStructureDefinition(Toolkit pToolkit, Scope pScope, StructureDefinition pValue) {
		...
		if (readLayer == null)
			...
			StructureDefinition fromRead =
				readLayer.lookupStructureDefinitionByName(pToolkit, pScope, pValue.getName());
			if (fromRead != null) {

				/* We need to write a tombstone */

				StructureDefinition tombstone = mStructureDefinitionWriteLayer
					.createNewTombstoneStructureDefinition(pToolkit, pScope, pValue.getName());
	...
	public @Nullable Integer lookupLatestStructureDefinitionRevision(Toolkit pToolkit, Scope pScope, String pDefName) {
		...
		Integer result =
			mStructureDefinitionWriteLayer.lookupLatestStructureDefinitionRevision(pToolkit, pScope, pDefName);
		if (result == null)
	...
	public void writeEditorStructureDefinition(Toolkit pToolkit, Scope pScope,
		...
		mEditorStructureDefinitionWriteLayer.writeEditorStructureDefinition(pToolkit, pScope,
	...
	public Collection<Structure> getAllStructuresByDefinition(Toolkit pToolkit, Scope pScope,
		...
		PersistenceLayer readLayer = mStructureReadLayer;
		if (readLayer == null)
			return mStructureWriteLayer.getAllStructuresByDefinition(pToolkit, pScope, pRef, pParentKey,
				pParentPropertyDef);
