...
public abstract class ToolkitFactory {
   ...
   * <p>
   * This method uses the following ordered lookup procedure to determine the <code>ToolkitFactory</code> implementation
   * class to load:
   * <ul>
  ...
  public static ToolkitFactory newInstance(@Nullable ClassLoader pLoader) {
    ...
    if (result == null) {
      ...
      result = newInstance(ToolkitFactory.class, "com.diamondq.common.model.generic.GenericToolkitFactory", pLoader);
    }
