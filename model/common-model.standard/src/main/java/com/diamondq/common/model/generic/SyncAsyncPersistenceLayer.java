...
public class SyncAsyncPersistenceLayer implements AsyncPersistenceLayer {
  ...
  public ContextExtendedCompletionStage<StructureDefinition> writeStructureDefinition(AsyncToolkit pToolkit,
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.writeStructureDefinition(pToolkit.getSyncToolkit(),
      pScope,
      pValue
    ));
  }
  ...
  public ContextExtendedCompletionStage<Collection<StructureDefinitionRef>> getAllStructureDefinitionRefs(
    ...
    return ContextExtendedCompletableFuture.completedFuture(mPersistenceLayer.getAllStructureDefinitionRefs(pToolkit.getSyncToolkit(),
      pScope
    ));
  }
  ...
  public ContextExtendedCompletionStage<@Nullable StructureDefinition> lookupStructureDefinitionByName(
    ...
    return ContextExtendedCompletableFuture.completedFuture(mPersistenceLayer.lookupStructureDefinitionByName(pToolkit.getSyncToolkit(),
      pScope,
      pName
    ));
  }
  ...
  public ContextExtendedCompletionStage<@Nullable StructureDefinition> lookupStructureDefinitionByNameAndRevision(
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.lookupStructureDefinitionByNameAndRevision(pToolkit.getSyncToolkit(),
      pScope,
      pName,
      pRevision
    ));
  ...
  public ContextExtendedCompletionStage<Boolean> writeStructure(AsyncToolkit pToolkit, Scope pScope,
    ...
    return ContextExtendedCompletableFuture.completedFuture(mPersistenceLayer.writeStructure(pToolkit.getSyncToolkit(),
      pScope,
      pStructure,
      pOldStructure
    ));
  ...
  public ContextExtendedCompletionStage<@Nullable Structure> lookupStructureBySerializedRef(AsyncToolkit pToolkit,
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.lookupStructureBySerializedRef(pToolkit.getSyncToolkit(),
      pScope,
      pSerializedRef
    ));
  }
  ...
  public ContextExtendedCompletionStage<@Nullable Structure> lookupStructureByPrimaryKeys(AsyncToolkit pToolkit,
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.lookupStructureByPrimaryKeys(pToolkit.getSyncToolkit(),
      pScope,
      pStructureDef,
      pPrimaryKeys
    ));
  ...
  public ContextExtendedCompletionStage<Boolean> deleteStructure(AsyncToolkit pToolkit, Scope pScope,
    Structure pValue) {
    return ContextExtendedCompletableFuture.completedFuture(mPersistenceLayer.deleteStructure(pToolkit.getSyncToolkit(),
      pScope,
      pValue
    ));
  }
  ...
  public ContextExtendedCompletionStage<Collection<Structure>> getAllStructuresByDefinition(AsyncToolkit pToolkit,
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.getAllStructuresByDefinition(pToolkit.getSyncToolkit(),
      pScope,
      pRef,
      pParentKey,
      pParentPropertyDef
  ...
  public ContextExtendedCompletionStage<List<Structure>> lookupStructuresByQuery(AsyncToolkit pToolkit, Scope pScope,
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.lookupStructuresByQuery(pToolkit.getSyncToolkit(),
      pScope,
      pQuery,
      pParamValues
    ));
  ...
  public ContextExtendedCompletionStage<ModelQuery> writeQueryBuilder(AsyncToolkit pToolkit, Scope pScope,
    ...
    return ContextExtendedCompletableFuture.completedFuture(mPersistenceLayer.writeQueryBuilder(pToolkit.getSyncToolkit(),
      pScope,
      pQueryBuilder
    ));
  }
  ...
  public StructureRef createStructureRefFromParts(AsyncToolkit pToolkit, Scope pScope, @Nullable Structure pStructure,
    ...
    return mPersistenceLayer.createStructureRefFromParts(pToolkit.getSyncToolkit(),
      pScope,
      pStructure,
      pPropName,
      pDef,
  ...
  public void addMigration(AsyncToolkit pToolkit, Scope pScope, String pStructureDefinitionName, int pFromRevision,
    ...
    mPersistenceLayer.addMigration(pToolkit.getSyncToolkit(),
      pScope,
  ...
  public @Nullable List<Pair<Integer, List<BiFunction<Structure, Structure, Structure>>>> determineMigrationPath(
    ...
    return mPersistenceLayer.determineMigrationPath(pToolkit.getSyncToolkit(),
      pScope,
      pStructureDefName,
      pFromRevision,
      pToRevision
  ...
  public ContextExtendedCompletionStage<@Nullable Integer> lookupLatestStructureDefinitionRevision(
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.lookupLatestStructureDefinitionRevision(pToolkit.getSyncToolkit(),
      pScope,
      pDefName
    ));
  }
  ...
  public ContextExtendedCompletionStage<Integer> countByQuery(AsyncToolkit pToolkit, Scope pScope, ModelQuery pQuery,
    ...
    return FutureUtils.completedFuture(mPersistenceLayer.countByQuery(pToolkit.getSyncToolkit(),
      pScope,
      pQuery,
      pParamValues
    ));
