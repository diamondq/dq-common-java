...
public class LoggingContextHandler implements ContextHandler {
  ...
  /**
   * @see com.diamondq.common.utils.misc.context.spi.ContextHandler#executeOnContextStart(com.diamondq.common.utils.misc.context.spi.ContextClass)
   */
  @Override
  ...
  /**
   * @see com.diamondq.common.utils.misc.context.spi.ContextHandler#executeOnContextClose(com.diamondq.common.utils.misc.context.spi.ContextClass,
   *      boolean)
   */
  @Override
  ...
  /**
   * @see com.diamondq.common.utils.misc.context.spi.ContextHandler#executeOnContextExplicitExit(com.diamondq.common.utils.misc.context.spi.ContextClass)
   */
  @Override
  ...
  /**
   * @see com.diamondq.common.utils.misc.context.spi.ContextHandler#executeOnContextExplicitExitWithMeta(com.diamondq.common.utils.misc.context.spi.ContextClass,
  ...
  /**
   * @see com.diamondq.common.utils.misc.context.spi.ContextHandler#executeOnContextExplicitThrowable(com.diamondq.common.utils.misc.context.spi.ContextClass,
   *      java.lang.Throwable)
   */
  @Override
  ...
  /**
   * @see com.diamondq.common.utils.misc.context.spi.ContextHandler#executeOnContextReportTrace(com.diamondq.common.utils.misc.context.spi.ContextClass,
   *      java.lang.Object[])
   */
  @Override
