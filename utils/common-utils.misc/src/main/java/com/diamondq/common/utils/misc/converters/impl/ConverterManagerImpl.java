package com.diamondq.common.utils.misc.converters.impl;

import com.diamondq.common.utils.misc.MiscMessages;
import com.diamondq.common.utils.misc.converters.Converter;
...
public class ConverterManagerImpl implements ConverterManager {
  ...
  /**
   * @see com.diamondq.common.utils.misc.converters.ConverterManager#convert(java.lang.Object, java.lang.Class)
   */
  @Override
  public <I, O> O convert(@NonNull I pInput, Class<O> pOutputClass) {
    ...
    if (matchClass == null) {
      ...
      if (matchClass == null)
        throw new ExtendedIllegalArgumentException(MiscMessages.CONVERTERMANAGER_NO_MATCH, rootClass.getName(),
