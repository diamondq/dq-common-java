package com.diamondq.common.utils.misc.versioning;
...
public final class SemanticVersion implements Comparable<SemanticVersion> {
	...
	public SemanticVersion(int pMajor, int pMinor, int pPatch, String[] pPreRelease, String[] pBuildMeta) {
		...
		this.preParts = new ArrayList<String>(5);
		this.metaParts = new ArrayList<String>(5);
		this.input = new char[0];
		this.buildMeta = new String[pBuildMeta.length];
		this.preRelase = new String[pPreRelease.length];
		...
		for (int i = 0; i < pPreRelease.length; i++) {
			...
			this.preRelase[i] = pPreRelease[i];
		}
