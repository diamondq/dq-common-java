...
public class TestBasicConverter {
  ...
  private static class ListStringConverter extends AbstractConverter<List<String>, String> {
    ...
    public ListStringConverter() {
      super(Types.LIST_OF_STRING, Types.STRING, null);
    }
  ...
  private static class ListLongConverter extends AbstractConverter<List<Long>, String> {
    ...
    public ListLongConverter() {
      super(Types.LIST_OF_LONG, Types.STRING, null);
    }
  ...
  public void genericConverter() throws IOException {
    ...
    ll.add(2L);
    ll.add(3L);
    String str1 = converterManager.convert(ls, Types.LIST_OF_STRING, Types.STRING);
    assertEquals("a,b,c", str1);
    String str2 = converterManager.convert(ll, Types.LIST_OF_LONG, Types.STRING);
