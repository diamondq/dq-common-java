...
public class PersistedState {
	...
	public PersistedState setRegistrationLocation(String pValue) {
		return new PersistedState(mStructure
			.updateProperty(mStructure.lookupMandatoryPropertyByName("registrationLocation").setValue(pValue)));
	}
	...
	public PersistedState setAuthorizationLocation(String pValue) {
		return new PersistedState(mStructure
			.updateProperty(mStructure.lookupMandatoryPropertyByName("authorizationLocation").setValue(pValue)));
	}
	...
	public PersistedState setCertificateLocation(@Nullable String pValue) {
		return new PersistedState(mStructure
			.updateProperty(mStructure.lookupMandatoryPropertyByName("certificateLocation").setValue(pValue)));
	}
