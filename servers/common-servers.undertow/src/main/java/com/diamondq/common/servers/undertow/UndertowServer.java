...
public abstract class UndertowServer {
  ...
  protected Undertow.Builder configureUndertowBuilder(Undertow.Builder pBuilder) {
    ...
    if ((httpEnabled != null) && (httpEnabled == true)) {
      ...
      if (httpHost == null)
        throw new RuntimeException("HTTP was enabled, but no web.http.bindhost configuration setting was provided");
    ...
    if ((httpsEnabled != null) && (httpsEnabled == true) && ((httpsProxied == null) || (httpsProxied == false))) {
      ...
      if (httpsPort == null)
        throw new RuntimeException("HTTPS was enabled, but no web.https.port configuration setting was provided");

      if (httpsHost == null)
        throw new RuntimeException("HTTPS was enabled, but no web.https.bindhost configuration setting was provided");
      ...
      SSLContext sslContext = createSSLContext(loadKeyStore(keystoreFile, keystorePassword), null, keystorePassword);
