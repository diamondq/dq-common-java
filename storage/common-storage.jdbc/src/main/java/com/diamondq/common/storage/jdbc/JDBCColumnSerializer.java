...
public class JDBCColumnSerializer implements IPreparedStatementSerializer {
    ...
    try {
      switch (pColDef.getType()) {
        case Boolean: {
          ...
          else if (obj instanceof String) value = Boolean.valueOf((String) obj);
          else if (obj instanceof Boolean) value = (Boolean) obj;
          else throw new IllegalArgumentException("Only Boolean or String supported, but found " + obj.getClass());
        ...
        case Decimal: {
          ...
          if ((minValue != null) && (minValue.equals(JDBCKVStore.sLONG_MIN_VALUE)) && (maxValue != null)
            ...
            Long value;
            if (obj == null) value = null;
            else if (obj instanceof String) value = Long.valueOf((String) obj);
            else if (obj instanceof Long) value = (Long) obj;
            else if (obj instanceof BigDecimal) value = ((BigDecimal) obj).longValue();
            ...
            BigDecimal value;
            if (obj == null) value = null;
            else if (obj instanceof String) value = new BigDecimal((String) obj);
            else if (obj instanceof BigDecimal) value = (BigDecimal) obj;
            else throw new IllegalArgumentException("Only BigDecimal or String supported, but found " + obj.getClass());
        ...
        case Integer: {
          Integer value;
          if (obj == null) value = null;
          else if (obj instanceof String) value = Integer.valueOf((String) obj);
          else if (obj instanceof Integer) value = (Integer) obj;
          else if (obj instanceof BigDecimal) value = ((BigDecimal) obj).intValue();
          else throw new IllegalArgumentException(
        ...
        case Long: {
          ...
          else if (obj instanceof Integer) value = ((Integer) obj).longValue();
          else if (obj instanceof Long) value = (Long) obj;
          else if (obj instanceof BigDecimal) value = ((BigDecimal) obj).longValue();
          else throw new IllegalArgumentException(
        ...
        case String: {
          String value;
          if (obj == null) value = null;
          else if (obj instanceof String) value = (String) obj;
          else if (obj instanceof UUID) value = ((UUID) obj).toString();
          else throw new IllegalArgumentException("Only String and UUID are supported, but found " + obj.getClass());
          Integer maxLength = pColDef.getMaxLength();
          if (maxLength != null) mDialect.writeText(pPs, pParamCount, value);
          else mDialect.writeUnlimitedText(pPs, pParamCount, value);
          return value;
        }
        case Timestamp: {
          Long value;
        ...
        case UUID: {
          UUID value;
          if (obj == null) value = null;
          else if (obj instanceof UUID) value = (UUID) obj;
          else throw new IllegalArgumentException("Only UUID supported, but found " + obj.getClass());
        ...
        case Binary: {
          byte[] value;
          if (obj == null) value = null;
          else if (obj instanceof byte[]) value = (byte[]) obj;
          else throw new IllegalArgumentException("Only byte[] supported, but found " + obj.getClass());
  ...
  public <@Nullable O> int serializeToPreparedStatement(O pObj, PreparedStatement pPs, int pStartAtIndex)
    throws SQLException {
    if (pObj == null) throw new UnsupportedOperationException();
    if (Map.class.isAssignableFrom(pObj.getClass()) == false) throw new UnsupportedOperationException();
    @SuppressWarnings("unchecked") Map<String, Object> data = (Map<String, Object>) pObj;
