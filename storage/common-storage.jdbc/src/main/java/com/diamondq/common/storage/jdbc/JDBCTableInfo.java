...
public class JDBCTableInfo {
	...
	/**
	 * Assumes that param 1 is key1, param 2 is key2, and that other parameters will be filled by the
	 * {@link #serializer}
	 */
	...
	/**
	 * Assumes that the first set of strings will be filled by the {@link #serializer}, and the last param is key2 and
	 * the second-to-last param is key1
	 */
