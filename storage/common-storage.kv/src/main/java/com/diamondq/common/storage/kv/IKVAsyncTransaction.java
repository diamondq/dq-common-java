...
public interface IKVAsyncTransaction {
	 ...
	 * @return the future
	 */
	public <@Nullable CONTEXT> ExtendedCompletableFuture<@NonNull Pair<@NonNull Boolean, CONTEXT>> removeByKey(String pTable,
	 ...
	 * @return the future
	 */
	public <@Nullable CONTEXT> ExtendedCompletableFuture<@NonNull Pair<Iterator<String>, CONTEXT>> keyIterator(String pTable,
		CONTEXT pContext);
	 ...
	 * @return the future
	 */
	public <@Nullable CONTEXT> ExtendedCompletableFuture<@NonNull Pair<@NonNull Iterator<@NonNull String>, CONTEXT>> keyIterator2(String pTable,
	 ...
	 * @return the future
	 */
	public <@Nullable CONTEXT> ExtendedCompletableFuture<@NonNull Pair<@NonNull Long, CONTEXT>> getCount(String pTable, CONTEXT pContext);
